...
{
    internal class TagRepositoryScriptCreator : UnityEditor.ProjectWindowCallback.EndNameEditAction
    {
...
public class {className} : TagRepository<{className}Data>
{{

}}
[System.Serializable]

public class {className}Data : TaggedData
{{
